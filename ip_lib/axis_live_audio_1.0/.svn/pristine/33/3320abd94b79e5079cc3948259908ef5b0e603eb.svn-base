...
generic (
	C_USE_AUDIO_IN			: BOOLEAN	:= FALSE;
	C_USE_AUDIO_OUT			: BOOLEAN	:= TRUE
);
port (
...
-- -- ---------------------------------------------------------------------------------
-- attribute keep of s_axis_tvalid			: signal is "true";
-- attribute mark_debug of s_axis_tvalid	: signal is "true";
-- attribute keep of s_axis_tdata			: signal is "true";
-- attribute mark_debug of s_axis_tdata	: signal is "true";
-- attribute keep of s_axis_tid			: signal is "true";
-- attribute mark_debug of s_axis_tid		: signal is "true";
----------------------------------------------------------------------------------
...
process(ref_clk_in)
begin
	if(ref_clk_in = '1' and ref_clk_in'event)then
